...
public class MeuTST<Value extends Comparable<Value>> {
    ...
    public Iterable<String> keysWithPrefixByValue(String prefix) {
        ...
        RedBlackBST<Value, String> aux_st = new RedBlackBST<Value, String>();
        Iterable<String> it1 = keysWithPrefix(prefix);
        for (String i : it1)
            aux_st.put(this.get(i), i);

        Iterable<Value> it2 = aux_st.keys();
        Stack<String> ans = new Stack<String>();
        for (Value i : it2)
            ans.push(aux_st.get(i));
    ...
    public void delete(String key) {
        ...
        Node<Value> n_root = null;

        Iterable<String> it = keys();
        for (String aux : it)
            if (aux.compareTo(key) != 0)
                n_root = put(n_root, aux, get(aux), 0);
    ...
    public static void main(String[] args) {
        ...
        MeuTST<Integer> teste = new MeuTST<Integer>();
        teste.put("felipe", 1);
        teste.put("fernando", 32);
        teste.put("bola", 35);
        teste.put("show", 43);
        teste.put("anda", 134);
        teste.put("esfira", 246);
        teste.put("hehe", 25235);

        Iterable<String> aux = teste.keysWithPrefixByValue("fe");
        ...
        StdOut.println("\n------------------\nListando 'fe' \n");
        aux = teste.keysWithPrefixByValue("fe");
        for (String pal : aux)
            StdOut.println(pal);
